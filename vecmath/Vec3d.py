...
class Vec3d(object):
    ...
    angle_around_z = property(get_angle_around_z, __setangle_around_z, None,
    ...
    angle_around_x = property(get_angle_around_x, __setangle_around_x, None,
    ...
    angle_around_y = property(get_angle_around_y, __setangle_around_y, None,
